...
import Dest from '/src/views/webs/airbnb-copy/comps/Dest.vue'
import GMap from '/src/views/webs/airbnb-copy/comps/maps/GMap.vue'
import { GET_NICK, GET_ISLANDS_COORDS } from '/src/views/webs/airbnb-copy/quries/quries.js'
