...
<script setup>
	...
	import { GET_DETAILS } from '/src/views/webs/airbnb-copy/quries/quries.js'
	import gql from 'graphql-tag'
	import AirNav from '/src/views/webs/airbnb-copy/comps/utils/AirNav.vue'
	import HostIntro from '/src/views/webs/airbnb-copy/comps/details/HostIntro.vue'
	import DestinationIntro from '/src/views/webs/airbnb-copy/comps/details/DestinationIntro.vue'
	import Description from '/src/views/webs/airbnb-copy/comps/details/Description.vue'
	import ImageExplorer from '/src/views/webs/airbnb-copy/comps/details/ImageExplorer.vue'
	import LuxImageExplorer from '/src/views/webs/airbnb-copy/comps/details/LuxImageExplorer.vue'
	import BedRooms from '/src/views/webs/airbnb-copy/comps/details/BedRooms.vue'
	import Offers from '/src/views/webs/airbnb-copy/comps/details/Offers.vue'
	import Host from '/src/views/webs/airbnb-copy/comps/details/Host.vue'
	import Review from '/src/views/webs/airbnb-copy/comps/details/Review.vue'
	import Things from '/src/views/webs/airbnb-copy/comps/details/Things.vue'
	import Rate from '/src/views/webs/airbnb-copy/comps/utils/Rate.vue'
	import Calendars from '/src/views/webs/airbnb-copy/comps/utils/Calendars.vue'
	import ExactLocation from '/src/views/webs/airbnb-copy/comps/maps/ExactLocation.vue'
